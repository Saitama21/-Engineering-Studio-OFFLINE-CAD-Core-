...
export function buildFacetedBRep(rec,{tolerance,maxDisplayEdges=42000,sharpAngleDeg=28}={}){
  ...
  return{
    version:'1.7.0',kernel:'ROZFOOD B-Rep Core Alpha',source:'SolidWorks FaceTessellations',geometryModel:'vertex-edge-face-shell',faceIdentity:topologyMode,exactParasolid:false,topologyComplete,coverage:round(coverage,4),sourceFaceIdentityCoverage:round(sourceIdentityCoverage,4),toleranceMm:tol,sharpAngleDeg,
