// ROZFOOD Engineering Studio v14.0.2 — Engineering Drawing Composer
...
export function composeDrumA2(rec,plan,{mode='assemblyDetailed',sectionPlan=null,hasCross=false}={}){
  ...
  return {version:'14.0.2',kernel:'ROZFOOD Engineering Drawing Composer',sheet:{format:'A2',W,H,frame},boxes,lanes,occupied,score,note:'Deterministic constrained layout. View slots are driven by model aspect/complexity and protected BOM/title-block regions; no ML/AI is used.'};
}
