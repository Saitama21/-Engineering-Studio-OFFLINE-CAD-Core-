// ROZFOOD Engineering Studio v14.3.0 — Production Leader Core
...
export function createProductionLeaderRouter(layout,{sheet={x:80,y:34,w:1554,h:1085},fontSize=9}={}){
  ...
  return {version:'14.3.0',kernel:'ROZFOOD Production Leader Core',leaders,route,render,renderAll:()=>leaders.map(render).join('')};
}
