// ROZFOOD Engineering Studio v14.0.0 — Reference-Grade Production Drafting Core
...
export function referenceGradeStats(graph,helix,aa,detail){
  return {version:'14.0.0',kernel:'ROZFOOD Reference-Grade Production Drafting Core',views:graph?.counts?.views||0,dimensions:graph?.counts?.dimensions||0,constraints:graph?.counts?.constraints||0,helicoidCurves:helix?.stats?.curves||0,aaStations:aa?.stats?.stations||0,detailD:detail?.stats||null};
}
