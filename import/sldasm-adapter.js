...
export async function parseSLDASM(input,fileName='assembly.SLDASM'){
  ...
  return{
    format:'SLDASM',adapter:'sldasm-native-brep-core-v1.5.1',geometryAvailable,isAssembly:true,unit:'mm',factor:1,bounds,counts,
