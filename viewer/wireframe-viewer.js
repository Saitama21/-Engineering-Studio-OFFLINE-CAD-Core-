...
export class WireframeViewer{
  constructor(canvas){
    this.canvas=canvas;this.ctx=canvas.getContext('2d');this.rec=null;this.rx=-.45;this.ry=.7;this.zoom=1;this.pan=[0,0];this.drag=null;this.down=null;this.moved=0;this.mode='solid';this.selectedComponent=null;this.hitFaces=[];this.onSelect=null;this.framePending=false;this.interacting=false;this.interactionTimer=null;
  ...
  drawFaceWire(c,scale,cx,cy,center){
    ...
    for(let fi=0;fi<faces.length;fi+=step){const f=faces[fi];
